...
(function ($) {
    ...
    $.fn.jumpto = function (options) {
        ...
        if (settings.closeButton != false) {
            var close = "<div class='jumpto-close'><a href='#' id='jumpto-close'>Fermer</a></div>"
        }

        if (settings.navContainer == false) {
            $(this).append("<nav class='jumpto-subnav  d-none d-lg-block'>" + title + "<ul class='jumpto-first'>" + html + "</ul>" + close + "</nav>")
        } else {
            $(settings.navContainer).addClass("jumpto-subnav  d-none d-lg-block").html(title + "<ul class='jumpto-first'>" + html + "</ul>" + close)
        }
